    ...
    def __init__(self, dim, depth, heads, dim_head, mlp_dim, h, w, att_dropout = 0., ff_dropout = 0., drop_path = 0., use_flash = True):
        ...
        for _ in range(depth):
            self.layers.append(
                ResidualAtt(
                    PreNorm(
                        dim, Attention(dim, heads=heads, dim_head=dim_head, dropout=att_dropout, use_flash=use_flash),
                    ),
                    ResidualSpect(
...
class ViTFlashAttnSpectralAttn(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, channels = 3, dim_head = 64, att_dropout = 0., ff_dropout = 0., drop_path = 0., use_flash = True):
        ...
        self.transformer = SpectralAttention(dim, depth, heads, dim_head, mlp_dim, h, w, att_dropout, ff_dropout, drop_path, use_flash)
